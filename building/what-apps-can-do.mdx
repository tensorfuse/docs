...
description: "Apps built on Whip can save your data, chat with AI, pull live info from the internet, use your camera, keep leaderboards, and host multiplayer sessions."
icon: "rocket"
keywords:
  [
    ...
    "whip multiplayer leaderboard",
  ]
---

Apps made on Whip are real apps, not mockups. They can remember your data between visits, hold their own AI conversations, pull live information from the internet, use your camera and location (only if you allow it), keep high-score leaderboards, and even run shared sessions you play with friends — all from a plain-language description.
...
## Compete and play together

- **Leaderboards** — game-style apps can keep a high-score board that tracks each player's personal best. Whip even notifies you when someone [beats your score](/using/play-together).
- **Shared sessions** — an app's owner can invite up to 10 people into one live copy of the app, where everyone sees the same data. Shared grocery lists, party scoreboards, trip planners — [here's how sessions work](/using/play-together).

## Look and feel like real apps

Under the hood, Whip gives the AI a serious toolkit — around 40 building blocks covering 3D and 2D graphics, sound and music, animations and visual effects, gestures, charts and data visualization, plus a dedicated game-building kit and proper fonts. Apps can show native pop-ups, run full-screen, and behave like something you'd download — because they are real apps.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Play together: sessions & leaderboards"
    icon="users"
    href="/using/play-together"
  >
    The multiplayer side of Whip, explained.
  </Card>
</CardGroup>
