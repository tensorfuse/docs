...
<AccordionGroup>
  <Accordion title="Can I unpublish later?" icon="eye-off">
    Yes. You can flip a version back to private whenever you like — it
    disappears from the feed and search right away. See [unpublish &
    archive](/sharing/unpublish-and-archive).
  </Accordion>
